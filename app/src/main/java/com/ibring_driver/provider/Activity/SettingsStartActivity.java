...
import com.ibring_driver.provider.Adapter.ServiceListAdapter;
...
import com.ibring_driver.provider.Models.ServiceListModel;
import com.ibring_driver.provider.R;
import com.ibring_driver.provider.Utils.KeyHelper;
import com.ibring_driver.provider.View.TBarView;
...
public class SettingsStartActivity extends Activity implements ServiceListAdapter.ServiceClickListener {
    ...
    private void sendServiceUpdateRequest() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,
                URLHelper.UPDATE_SERVICE, object, new Response.Listener<JSONObject>() {
            @Override
    ...
    private void setupToolbar(View view) {
        ...
        tBarView.setupToolbar(R.drawable.menu_white, getString(R.string.menu_settings), false, false);
    }
