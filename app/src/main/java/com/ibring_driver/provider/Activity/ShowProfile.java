...
public class ShowProfile extends AppCompatActivity {
    ...
    public void getProfile()
    {
        ...
        Log.e("Token ","Bearer" + " " + SharedHelper.getKey(context, "access_token"));
        JSONObject object = new JSONObject();
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,
                URLHelper.SHOW_PROFILE + "?user_id=" + strUserId,
                object, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonProviderObj) {
                try {
                    if (jsonProviderObj.optString("email") != null && !jsonProviderObj.optString("email").
                    ...
                    if (jsonProviderObj.optString("mobile") != null && !jsonProviderObj.optString("mobile")
                            .equalsIgnoreCase("null")
